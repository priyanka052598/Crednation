...
function ShowModalAfterBooking() {
  ...
  return (
    <div>  
        ...
        <p className="text-[20px] my-7 text-gray-150 text-center font-normal">Congratulations for your booking, we will reach out to you with jobs soon.</p>
      </div>
...
export default ShowModalAfterBooking