...
const BookingPage = () => {
  ...
  return (
    <div className="w-full relative [background:linear-gradient(179.41deg,_#18181b,_#3e065f)] flex flex-col items-center justify-center min-w-[320px] text-left text-base text-ripe-plum-50 font-lg-normal">
      <Header />
      <div className="    flex flex-row items-center justify-center flex-w content-center p-8 gap-x-8 gap-y-15 text-xl text-components-button-component-primarycolor">
        {/* <div className="flex-1 flex  flex-col items-center justify-center gap-8 min-w-[256px]"> */}

          {
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-4 min-w-[256px]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-8 text-base">
                <div className="self-stretch flex flex-col items-end justify-start gap-6">
                  <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start gap-6">
                ...
                <div onClick={nextStep} className="self-stretch shadow-[0px_1px_2px_rgba(0,_0,_0,_0.03),_0px_1px_6px_-1px_rgba(0,_0,_0,_0.02),_0px_2px_4px_rgba(0,_0,_0,_0.02)] rounded-lg bg-ripe-plum-950 h-[59px] flex flex-row items-center justify-center py-[15px] px-12 box-border text-center text-ripe-plum-50">
  ...
  <div className="self-stretch shadow-[0px_1px_2px_rgba(0,_0,_0,_0.03),_0px_1px_6px_-1px_rgba(0,_0,_0,_0.02),_0px_2px_4px_rgba(0,_0,_0,_0.02)] rounded-lg bg-ripe-plum-950 h-[59px] flex flex-row items-center justify-center py-[15px] px-12 box-border min-w-[256px] text-center text-base text-ripe-plum-50">
    <div className="relative leading-[24px]">Next</div>
          ...
          {step === 3 &&
            ...
            <div className=" flex flex-col items-start justify-start gap-4 min-w-[256px]">
              <div className="self-stretch flex  items-center justify-start gap-2 ">
                <FaArrowLeft onClick={prevStep} className="text-[16px] cursor-pointer" />
                <div className=" w-fit relative leading-[28px] font-semibold inline-block ">
                  Card Details
                </div>
                <img className="w-10 relative h-1" alt="" src="/vector6.svg" />
              </div>
              <div className="self-stretch flex flex-col items-start justify-start min-w-[256px] text-base">
                <div className="self-stretch flex flex-col items-end justify-start gap-4 min-w-[256px]">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[2px] min-w-[256px]">
                    <div className="self-stretch relative leading-[24px] font-semibold inline-block min-w-[256px]">
                      Card Number
                    </div>
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start gap-4">
                    <div className="self-stretch flex flex-row items-center justify-start flex-wrap content-center gap-4">
                      <div className="flex-1 flex flex-col items-start justify-start gap-[2px] min-w-[256px]">
          ...
          {/* {showModal && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white text-black p-6 rounded-lg text-center">
                <h2 className="text-xl font-bold mb-4">Confirmation Successful!</h2>
                <p>Aapne Step 3 Confirm kar diya hai.</p>
...

        {
          ...
          <div className={` ${window.innerWidth>500?"w-[80%":"w-[200px]"} w-[%] mb-8   text-base`}>
            ...
            <div className={` justify-center items-center gap-6 ${window.innerWidth<500?" flex flex-col":"flex"}` }>
              ...
              <div className=" w-full rounded-components-input-global-borderradiussm bg-gray-100 border-darkslategray border-[1px] border-solid flex flex-col items-center justify-center p-4 gap-4 text-xs text-bunker-300">
              ...
              <div className="w-full rounded-lg [background:linear-gradient(180deg,_#18181b,_#2c0c40_57.5%,_#3e065f)] border-bunker-600 border-[1px] border-solid flex flex-col items-center justify-center p-8 gap-4">
                ...
                <img
                  ...
                  src="/vector-101.svg"
                />
                <div onClick={nextStep} className="self-stretch shadow-[0px_1px_2px_rgba(0,_0,_0,_0.03),_0px_1px_6px_-1px_rgba(0,_0,_0,_0.02),_0px_2px_4px_rgba(0,_0,_0,_0.02)] rounded-lg bg-ripe-plum-500 h-14 flex flex-row items-center justify-center py-[15px] px-12 box-border text-center text-ripe-plum-50">
                  <div className="relative leading-[24px] font-semibold">
                    Confirm Booking
                  </div>
                </div>
              ...
              <div className="w-full rounded-components-input-global-borderradiussm bg-gray-100 border-darkslategray border-[1px] border-solid flex flex-col items-start justify-center p-4 gap-4">
